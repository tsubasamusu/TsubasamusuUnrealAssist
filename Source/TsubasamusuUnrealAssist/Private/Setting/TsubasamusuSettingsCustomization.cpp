...
void FTsubasamusuSettingsCustomization::AddCommentGenerationLanguageProperty(IDetailLayoutBuilder& InDetailLayoutBuilder)
{
    ...
    const FText ToolTipText = LOCTEXT("CommentGenerationLanguageToolTip", "The language of comments generated by GPT. (This property will become editable if you uncheck \"Use Editor Language.\")");
...
void FTsubasamusuSettingsCustomization::AddGptModelsDocumentButton(IDetailLayoutBuilder& InDetailLayoutBuilder)
{
    ...
    const FText HintText = LOCTEXT("GptModelsDocumentButtonHint", "gpt-4o-mini");
    const FText ToolTipText = LOCTEXT("GptModelsDocumentButtonToolTip", "View the types of GPT models currently available");
