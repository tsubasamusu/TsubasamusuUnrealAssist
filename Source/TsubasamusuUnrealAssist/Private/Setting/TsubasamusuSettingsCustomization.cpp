...
void FTsubasamusuSettingsCustomization::AddGptLanguageProperty(IDetailLayoutBuilder& DetailLayout)
{
    ...
    const FText ToolTipText = LOCTEXT("GptLanguageToolTipText", "The language of comments generated by GPT. (This property will become editable if you check \"Use Editor Language\".)");
