...
void UAccessSpecifierInitializer::RegisterBlueprint(UBlueprint* InBlueprint)
{
	if (IsValid(InBlueprint) && !IsRegisteredBlueprint(InBlueprint))
	{
		...
		BlueprintMemberSet.BlueprintChangedEventHandle = InBlueprint->OnChanged().AddUObject(this, &UAccessSpecifierInitializer::OnBlueprintChanged);
		BlueprintMemberSets.Add(BlueprintMemberSet);
	}
}

void UAccessSpecifierInitializer::UnregisterAllBlueprints()
{
	for (const FBlueprintMemberSet& BlueprintMemberSet : BlueprintMemberSets)
	{
		if (BlueprintMemberSet.IsValid())
		{
			BlueprintMemberSet.Blueprint->OnChanged().Remove(BlueprintMemberSet.BlueprintChangedEventHandle);
		}
	}
...
bool UAccessSpecifierInitializer::IsRegisteredBlueprint(UBlueprint* InBlueprint)
{
...
FBlueprintMemberSet UAccessSpecifierInitializer::FindBlueprintMemberSet(UBlueprint* InBlueprint)
{
...
FBlueprintMemberSet UAccessSpecifierInitializer::CreateBlueprintMemberSet(UBlueprint* InBlueprint)
{
	if (IsValid(InBlueprint))
	{
